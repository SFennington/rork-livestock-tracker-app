      ...
      <View style={styles.form}>
            ...
            <View style={styles.categoryGrid}>
              {settings.incomeTypes.map((type) => {
                ...
                return (
                  <TouchableOpacity
                    key={type}
                    style={[styles.categoryButton, incomeType === type && (transactionType === 'income' ? styles.categoryButtonActiveIncome : styles.categoryButtonActive)]}
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={styles.livestockButtons}>
            <TouchableOpacity
              style={[styles.livestockButton, livestockType === 'general' && (transactionType === 'income' ? styles.livestockButtonActiveIncome : styles.livestockButtonActive)]}
            ...
            {settings.enabledAnimals.chickens && (
              <TouchableOpacity
                style={[styles.livestockButton, livestockType === 'chicken' && (transactionType === 'income' ? styles.livestockButtonActiveIncome : styles.livestockButtonActive)]}
            ...
            {settings.enabledAnimals.ducks && (
              <TouchableOpacity
                style={[styles.livestockButton, livestockType === 'duck' && (transactionType === 'income' ? styles.livestockButtonActiveIncome : styles.livestockButtonActive)]}
            ...
            {settings.enabledAnimals.rabbits && (
              <TouchableOpacity
                style={[styles.livestockButton, livestockType === 'rabbit' && (transactionType === 'income' ? styles.livestockButtonActiveIncome : styles.livestockButtonActive)]}
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={styles.dateButtonsRow}>
            <TouchableOpacity
              style={[styles.dateQuickButton, date === getDateString(0) && (transactionType === 'income' ? styles.dateQuickButtonActiveIncome : styles.dateQuickButtonActive)]}
            ...
            <TouchableOpacity
              style={[styles.dateQuickButton, date === getDateString(1) && (transactionType === 'income' ? styles.dateQuickButtonActiveIncome : styles.dateQuickButtonActive)]}
            ...
            <TouchableOpacity
              style={[styles.dateQuickButton, date === getDateString(2) && (transactionType === 'income' ? styles.dateQuickButtonActiveIncome : styles.dateQuickButtonActive)]}
