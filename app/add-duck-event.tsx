...
export default function AddDuckEventScreen() {
  ...
  const handleSave = async () => {
    ...
    if (eventType === 'acquired' && !sex) {
      Alert.alert("Error", "Please select a gender for acquired ducks");
      return;
    }
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalList}>
              ...
              {getAliveAnimals('duck', breed || undefined).length === 0 && (
                <Text style={styles.emptyModalText}>No ducks available</Text>
              )}
            </ScrollView>
          </View>
        </View>
